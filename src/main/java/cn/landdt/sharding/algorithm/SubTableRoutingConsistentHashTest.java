package cn.landdt.sharding.algorithm;
...
//        virtualMap.clear();
    ...
    public static void main(String[] args) {
        ...
        Map<Integer, String> leftMap = consistentHashStatMap(11, 2, 100000);
...
//        Map<Integer, String> rightMap = consistentHashStatMap(33, 132, 100000);
...
//        System.out.println("======================迁移率统计结束==========================");
    ...
    public static void main1(String[] args) {
        ...
        for (int i = 0; i < 100; i++) {
            System.out.println(hash("192.168.1.19"));
        }
    }
}